import { aj as BaseError, a9 as getAbiItem, e6 as AbiEventNotFoundError, a6 as formatAbiItem, e7 as toEventSelector, e8 as keccak256, e9 as toBytes, ac as encodeAbiParameters, ea as numberToHex, eb as prettyPrint, ec as formatGwei, ed as formatEther, ee as getNodeError, ef as UnknownNodeError, eg as formatBlock, eh as getAction, ei as hexToBigInt, ej as hexToNumber, ek as TransactionExecutionError, el as parseAccount, em as assertRequest, en as formatTransactionRequest, eo as extract, ep as formatTransaction, eq as LruMap, er as blobsToCommitments, es as commitmentsToVersionedHashes, et as blobsToProofs, eu as toBlobSidecars, ev as getTransactionType, ew as recoverAuthorizationAddress, ex as serializeStateOverride, ey as encodeFunctionData, ez as getContractError, eA as AbiEventSignatureEmptyTopicsError, eB as AbiEventSignatureNotFoundError, eC as DecodeLogTopicsMismatch, a8 as decodeAbiParameters, eD as AbiDecodingDataSizeTooSmallError, eE as PositionOutOfBoundsError, eF as DecodeLogDataMismatch, eG as size$1, an as isAddressEqual, eH as formatLog, ao as call, eI as decodeFunctionResult, al as stringify, eJ as InvalidInputRpcError, eK as ContractFunctionRevertedError, ar as isHex, eL as bytesToHex, eM as stringToBytes, ap as concat, eN as getChainContractAddress, eO as addressResolverAbi, eP as toHex, eQ as universalResolverResolveAbi, eR as readContract, eS as trim, eT as textResolverAbi, eU as universalResolverReverseAbi, eV as getCallError, eW as MethodNotSupportedRpcError, eX as stringToHex, aq as HttpRequestError, eY as UnknownRpcError, eZ as UserRejectedRequestError, e_ as AtomicityNotSupportedError, e$ as AtomicReadyWalletRejectedUpgradeError, f0 as BundleTooLargeError, f1 as UnknownBundleIdError, f2 as DuplicateIdError, f3 as UnsupportedChainIdError, f4 as UnsupportedNonOptionalCapabilityError, f5 as SwitchChainError, f6 as ChainDisconnectedError, f7 as ProviderDisconnectedError, f8 as UnsupportedProviderMethodError, f9 as UnauthorizedProviderError, fa as JsonRpcVersionUnsupportedError, fb as LimitExceededRpcError, fc as TransactionRejectedRpcError, fd as ResourceUnavailableRpcError, fe as ResourceNotFoundRpcError, ff as InternalRpcError, fg as InvalidParamsRpcError, fh as MethodNotFoundRpcError, fi as InvalidRequestRpcError, fj as ParseRpcError, fk as TimeoutError, fl as integerRegex, fm as isAddress, fn as InvalidAddressError, fo as bytesRegex, fp as BytesSizeMismatchError, fq as TransactionNotFoundError, fr as TransactionReceiptNotFoundError, fs as formatTransactionReceipt, ft as multicall3Abi, fu as multicall3Bytecode, fv as AbiDecodingZeroDataError, fw as RawContractError, fx as toRpc, fy as validate, fz as BaseError$1, fA as validate$1, fB as slice, fC as keccak256$1, fD as fromString, d2 as formatAbiItem$1, fE as concat$1, fF as encode$1, fG as deploylessCallViaBytecodeBytecode, fH as verifyHash, fI as withResolvers, fJ as WaitForTransactionReceiptTimeoutError, fK as TransactionReceiptRevertedError, fL as getCode, fM as createBatchScheduler, fN as RpcRequestError } from "./appkit-DOrUN3iw.js";
import { g7, g8, g9, ga, gb, ab, aa, gc, ae, af, a7, gG, gj, gg, fO, gh, gk, gl, gm, gt, gu, gv, gw, gp, gx, gy, gd, ge, I, fP, fQ, ag, gq, gi, gf, fR, gr, gI, fS, fT, fU, gJ, fV, gK, fW, gz, gA, gB, gE, gF, gn, gs, go, fY, gH, gC, gD, fZ, f_, hj, hk, hl, h2, h5, gZ, g_, g$, h0, gN, gP, gT, ad, am, h7, gR, h8, ha, hb, g1, gL, f$, g0, g2, g5, gS, ho, gO, hf, a5, hf as hf2, g6, h1, h3, g3, g4, h4, gU, gV, gW, fX, d1, gM, hg, hh, hc, hm, hi, hn, hd, hi as hi2, a4, gX, gY, gQ, he, hf as hf3, he as he2, a5 as a52, hf as hf4, h6, h9, g0 as g02, g2 as g22 } from "./appkit-DOrUN3iw.js";
import { l as localBatchGatewayUrl } from "./ccip-Bgeyzcof.js";
import { c, c as c2, d, e, a, o, b, f } from "./ccip-Bgeyzcof.js";
...
async function prepareTransactionRequest(client, args) {
  ...
  const fillResult = attemptFill ? await getAction(client, fillTransaction, "fillTransaction")({ ...request, nonce }).then((result) => {
    ...
    if (error.name !== "TransactionExecutionError")
      return request;
    const unsupported = (_a2 = error.walk) == null ? void 0 : _a2.call(error, (e3) => {
      const error2 = e3;
...
export {
  g7 as AbiConstructorNotFoundError,
  g8 as AbiConstructorParamsNotFoundError,
  AbiDecodingDataSizeTooSmallError,
  AbiDecodingZeroDataError,
  g9 as AbiEncodingArrayLengthMismatchError,
  ga as AbiEncodingBytesSizeMismatchError,
  gb as AbiEncodingLengthMismatchError,
  ab as AbiErrorInputsNotFoundError,
  aa as AbiErrorNotFoundError,
  gc as AbiErrorSignatureNotFoundError,
  AbiEventNotFoundError,
  AbiEventSignatureEmptyTopicsError,
  AbiEventSignatureNotFoundError,
  ae as AbiFunctionNotFoundError,
  af as AbiFunctionOutputsNotFoundError,
  a7 as AbiFunctionSignatureNotFoundError,
  gG as AccountStateConflictError,
  ...
  gj as CallExecutionError,
  ChainDisconnectedError,
  gg as ChainDoesNotSupportContract,
  fO as CircularReferenceError,
  gh as ClientChainNotConfiguredError,
  gk as ContractFunctionExecutionError,
  ContractFunctionRevertedError,
  gl as ContractFunctionZeroDataError,
  gm as CounterfactualDeploymentFailedError,
  ...
  gt as ExecutionRevertedError,
  gu as FeeCapTooHighError,
  gv as FeeCapTooLowError,
  FilterTypeNotSupportedError,
  HttpRequestError,
  gw as InsufficientFundsError,
  gp as IntegerOutOfRangeError,
  InternalRpcError,
  gx as IntrinsicGasTooHighError,
  gy as IntrinsicGasTooLowError,
  gd as InvalidAbiDecodingTypeError,
  ge as InvalidAbiEncodingTypeError,
  I as InvalidAbiItemError,
  fP as InvalidAbiParametersError,
  fQ as InvalidAbiTypeParameterError,
  InvalidAddressError,
  ag as InvalidArrayError,
  gq as InvalidBytesBooleanError,
  gi as InvalidChainIdError,
  gf as InvalidDefinitionTypeError,
  InvalidDomainError,
  fR as InvalidFunctionModifierError,
  gr as InvalidHexBooleanError,
  InvalidInputRpcError,
  gI as InvalidLegacyVError,
  fS as InvalidModifierError,
  fT as InvalidParameterError,
  InvalidParamsRpcError,
  fU as InvalidParenthesisError,
  InvalidPrimaryTypeError,
  InvalidRequestRpcError,
  gJ as InvalidSerializableTransactionError,
  fV as InvalidSignatureError,
  gK as InvalidStorageKeySizeError,
  fW as InvalidStructSignatureError,
  ...
  gz as NonceMaxValueError,
  gA as NonceTooHighError,
  gB as NonceTooLowError,
  ParseRpcError,
  ProviderDisconnectedError,
  gE as ProviderRpcError,
  RawContractError,
  ResourceNotFoundRpcError,
  ResourceUnavailableRpcError,
  gF as RpcError,
  RpcRequestError,
  gn as SizeExceedsPaddingSizeError,
  gs as SizeOverflowError,
  go as SliceOffsetOutOfBoundsError,
  fY as SolidityProtectedKeywordError,
  gH as StateAssignmentConflictError,
  SwitchChainError,
  TimeoutError,
  gC as TipAboveFeeCapError,
  TransactionExecutionError,
  TransactionNotFoundError,
  TransactionReceiptNotFoundError,
  TransactionRejectedRpcError,
  gD as TransactionTypeNotSupportedError,
  UnauthorizedProviderError,
  UnknownBundleIdError,
  UnknownNodeError,
  UnknownRpcError,
  fZ as UnknownSignatureError,
  f_ as UnknownTypeError,
  ...
  assertRequest,
  hj as assertTransactionEIP1559,
  hk as assertTransactionEIP2930,
  hl as assertTransactionLegacy,
  blobsToCommitments,
  blobsToProofs,
  h2 as boolToBytes,
  h5 as boolToHex,
  ...
  c as ccipFetch,
  c2 as ccipRequest,
  gN as checksumAddress,
  gP as commitmentToVersionedHash,
  ...
  createTransport,
  decodeAbiParameters,
  am as decodeErrorResult,
  decodeEventLog,
  d as decodeFunctionData,
  decodeFunctionResult,
  h7 as defineBlock,
  gR as defineChain,
  h8 as defineTransaction,
  ha as defineTransactionReceipt,
  hb as defineTransactionRequest,
  deploylessCallViaBytecodeBytecode,
  g1 as deploylessCallViaFactoryBytecode,
  encodeAbiParameters,
  gL as encodeDeployData,
  e as encodeErrorResult,
  encodeEventTopics,
  encodeFunctionData,
  a as encodeFunctionResult,
  f$ as erc20Abi,
  g0 as erc6492SignatureValidatorAbi,
  g2 as erc6492SignatureValidatorByteCode,
  ethAddress,
  g5 as etherUnits,
  gS as extendSchema,
  formatBlock,
  ...
  hf as getEventSignature,
  a5 as getFunctionSelector,
  hf2 as getFunctionSignature,
  getTransactionType,
  ...
  f as offchainLookupSignature,
  gU as pad,
  gV as padBytes,
  gW as padHex,
  fX as parseAbi,
  parseAbiItem,
  d1 as parseAbiParameters,
  parseEventLogs,
  gM as prepareEncodeFunctionData,
  presignMessagePrefix,
  publicActions,
  hg as recoverAddress,
  hh as recoverPublicKey,
  hc as rpcTransactionType,
  hm as serializeAccessList,
  hi as serializeSignature,
  hn as serializeTransaction,
  hd as sha256,
  hi2 as signatureToHex,
  size$1 as size,
  a4 as slice,
  gX as sliceBytes,
  gY as sliceHex,
  ...
  he as toEventHash,
  toEventSelector,
  hf3 as toEventSignature,
  he2 as toFunctionHash,
  a52 as toFunctionSelector,
  hf4 as toFunctionSignature,
  toHex,
  toPrefixedMessage,
  h6 as toRlp,
  h9 as transactionType,
  trim,
  g02 as universalSignatureValidatorAbi,
  g22 as universalSignatureValidatorByteCode,
  validateTypedData,
  withCache,
  withRetry,
  withTimeout,
...
//# sourceMappingURL=index-CHfYWJjB.js.map
