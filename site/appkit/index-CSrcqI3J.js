import { n as css, r as resetStyles, o as elementStyles, q as i, t as b, u as i$1, Y as W3mFrameHelpers, R as RouterController, J as ConnectorController, a as CoreHelperUtil, S as SnackController } from "./appkit-DOrUN3iw.js";
  ...
  render() {
    return b`
      <wui-flex gap="1" data-testid="wui-otp-input">
        ${Array.from({ length: this.length }).map((_, index) => b`
            <wui-input-numeric
  ...
  render() {
    ...
    return b`
      ...
      >
        ...
        ${this.loading ? b`<wui-loading-spinner size="xl" color="accent-primary"></wui-loading-spinner>` : b` <wui-flex flexDirection="column" alignItems="center" gap="2">
              <wui-otp
                dissabled
                length="6"
...
//# sourceMappingURL=index-CSrcqI3J.js.map
