import { n as n$1, Y, t as tt, p, O, s } from "./property-etu9joDK.js";
var Z = Object.defineProperty, n = Object.getOwnPropertyDescriptor, o = (a, s2, p2, i) => {
  for (var e = i > 1 ? void 0 : i ? n(s2, p2) : s2, l = a.length - 1, H; l >= 0; l--)
    (H = a[l]) && (e = (i ? H(s2, p2, e) : H(e)) || e);
  return i && e && Z(s2, p2, e), e;
};
let t = class extends n$1 {
  constructor() {
...
//# sourceMappingURL=PhDeviceMobile-CfIsBgJb.js.map
