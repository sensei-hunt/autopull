import { n as css, r as resetStyles, o as elementStyles, q as i, t as b, C as ChainController, S as SnackController, L as AssetUtil, T as ThemeController, D as getPreferredAccountType, W as W3mFrameRpcConstants, R as RouterController, a as CoreHelperUtil } from "./appkit-DOrUN3iw.js";
...
let WuiCompatibleNetwork = class WuiCompatibleNetwork2 extends i {
  ...
  networksTemplate() {
    ...
    return b` <wui-flex class="networks">
      ${slicedNetworks == null ? void 0 : slicedNetworks.map((network) => b` <wui-flex class="network-icon"> <wui-image src=${network}></wui-image> </wui-flex>`)}
    </wui-flex>`;
  }
};
...
let W3mWalletReceiveView = class W3mWalletReceiveView2 extends i {
  ...
  networkTemplate() {
    ...
    if (getPreferredAccountType(caipNetwork == null ? void 0 : caipNetwork.chainNamespace) === W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT && isNetworkEnabledForSmartAccounts) {
      ...
      return b`<wui-compatible-network
...
//# sourceMappingURL=receive-BTMu62GT.js.map
