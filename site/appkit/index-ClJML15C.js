import { u as i, r as resetStyles, q as i$1, t as b, w, v as vars, n as css } from "./appkit-DOrUN3iw.js";
import { n as n$1, a as e } from "./class-map-B0iniyJ1.js";
const DECIMAL_POINT = ".";
const UiHelperUtil = {
 ...
 */
const a = /* @__PURE__ */ Symbol.for(""), o = (t) => {
  if ((t == null ? void 0 : t.r) === a) return t == null ? void 0 : t._$litStatic$;
}, s = (t) => ({ _$litStatic$: t, r: a }), l = /* @__PURE__ */ new Map(), n = (t) => (r, ...e2) => {
  const a2 = e2.length;
  let s2, i2;
  const n2 = [], u2 = [];
  let c, $ = 0, f = false;
  for (; $ < a2; ) {
    for (c = r[$]; $ < a2 && void 0 !== (i2 = e2[$], s2 = o(i2)); ) c += s2 + r[++$], f = true;
    $ !== a2 && u2.push(i2), n2.push(c), $++;
  }
  if ($ === a2 && n2.push(r[a2]), f) {
    const t2 = n2.join("$$lit$$");
    void 0 === (r = l.get(t2)) && (n2.raw = n2, l.set(t2, r = n2)), e2 = u2;
  }
  return t(r, ...e2);
}, u = n(b);
...
const phosphorImports = {
  "ph-arrow-circle-down": () => import("./PhArrowCircleDown-CPeNSdqG.js"),
  "ph-arrow-clockwise": () => import("./PhArrowClockwise-BO4ehBhF.js"),
  "ph-arrow-down": () => import("./PhArrowDown-BYo39HU9.js"),
  "ph-arrow-left": () => import("./PhArrowLeft-D4UN_iom.js"),
  "ph-arrow-right": () => import("./PhArrowRight-Cms_eH0p.js"),
  "ph-arrow-square-out": () => import("./PhArrowSquareOut-Dzz5fR-L.js"),
  "ph-arrows-down-up": () => import("./PhArrowsDownUp-z-zJiBMi.js"),
  "ph-arrows-left-right": () => import("./PhArrowsLeftRight-CH3wPRMQ.js"),
  "ph-arrow-up": () => import("./PhArrowUp-O43fyjho.js"),
  "ph-arrow-up-right": () => import("./PhArrowUpRight-XjadPB8D.js"),
  "ph-arrows-clockwise": () => import("./PhArrowsClockwise-B822Ri99.js"),
  "ph-bank": () => import("./PhBank-Dsx6Xti8.js"),
  "ph-browser": () => import("./PhBrowser-B2hlDiDg.js"),
  "ph-caret-down": () => import("./PhCaretDown-vVbdDmDN.js"),
  "ph-caret-left": () => import("./PhCaretLeft-CmOOiZlm.js"),
  "ph-caret-right": () => import("./PhCaretRight-DIDNr2rI.js"),
  "ph-caret-up": () => import("./PhCaretUp-CB_HK5yg.js"),
  "ph-check": () => import("./PhCheck-Dao45cLk.js"),
  "ph-circle-half": () => import("./PhCircleHalf-Djov-Sjv.js"),
  "ph-clock": () => import("./PhClock-CO5CfhLc.js"),
  "ph-compass": () => import("./PhCompass-BxKYmotJ.js"),
  "ph-copy": () => import("./PhCopy-CLR3s8OZ.js"),
  "ph-credit-card": () => import("./PhCreditCard-zqU5_QYP.js"),
  "ph-currency-dollar": () => import("./PhCurrencyDollar-DooAsWDv.js"),
  "ph-desktop": () => import("./PhDesktop-DXtSMPxA.js"),
  "ph-device-mobile": () => import("./PhDeviceMobile-CfIsBgJb.js"),
  "ph-dots-three": () => import("./PhDotsThree-HcfvxdKQ.js"),
  "ph-vault": () => import("./PhVault-DlizfcEC.js"),
  "ph-envelope": () => import("./PhEnvelope-CjJdFJUX.js"),
  "ph-funnel-simple": () => import("./PhFunnelSimple-Bq757S8L.js"),
  "ph-globe": () => import("./PhGlobe-Da8o82fo.js"),
  "ph-identification-card": () => import("./PhIdentificationCard-B5gB_fPs.js"),
  "ph-image": () => import("./PhImage-CBZdqb6V.js"),
  "ph-info": () => import("./PhInfo-zzwE3V4C.js"),
  "ph-lightbulb": () => import("./PhLightbulb-HhayE2hJ.js"),
  "ph-magnifying-glass": () => import("./PhMagnifyingGlass-HBbPQBzj.js"),
  "ph-paper-plane-right": () => import("./PhPaperPlaneRight-BJunRUCM.js"),
  "ph-plus": () => import("./PhPlus-CLmJbVu4.js"),
  "ph-power": () => import("./PhPower-DyAjo7pi.js"),
  "ph-puzzle-piece": () => import("./PhPuzzlePiece-C2JI0tK8.js"),
  "ph-qr-code": () => import("./PhQrCode-CPuivV81.js"),
  "ph-question": () => import("./PhQuestion-DVonNsUB.js"),
  "ph-question-circle": () => import("./PhQuestionMark-Bykciggb.js"),
  "ph-seal-check": () => import("./PhSealCheck-BvcggUU1.js"),
  "ph-sign-out": () => import("./PhSignOut-CugU9aDs.js"),
  "ph-spinner": () => import("./PhSpinner-DfWYCT6K.js"),
  "ph-trash": () => import("./PhTrash-C5TPsGrJ.js"),
  "ph-user": () => import("./PhUser-CfGrTrcV.js"),
  "ph-wallet": () => import("./PhWallet-BhleCwBn.js"),
  "ph-warning": () => import("./PhWarning-DnVCNea6.js"),
  "ph-warning-circle": () => import("./PhWarningCircle-DGEQIObW.js"),
  "ph-x": () => import("./PhX-DbvW2nf0.js")
};
const svgOptions = {
...
//# sourceMappingURL=index-ClJML15C.js.map
